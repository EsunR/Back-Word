<template>
  <div id="manageUser" class="e_card">
    ...
    <el-row :gutter="20" style="margin-bottom: 20px;">
      <el-col :span="8" v-for="(item,index) in userList" :key="item.id">
        <div class="grid-content">
          ...
          <div class="btn_box">
            <el-button type="info" icon="el-icon-success" v-if="item.status == '1'" disabled>已审核</el-button>
            <el-button
              type="success"
              icon="el-icon-success"
              v-if="item.status == '0'"
              @click="access(index,item.uid)"
            >通过审核</el-button>
            <el-button type="danger" icon="el-icon-delete" @click="deleteUser(index,item.uid)"></el-button>
